          ...
          <div class="box">
            ...
            <div class="box-body">
              <form method="post" action="<?php echo base_url() ?>koperasi/cetak_excel">
                ...
                <button type="button" class="btn btn-block btn-primary btn-sm"><i class="fa fa-fw fa-print"></i>Cetak</button>
              </form>
              <a href="<?php echo base_url() ?>koperasi/cetak"><button type="button" class="btn btn-block btn-success btn-sm"><i class="fa fa-fw fa-backward"></i>Kembali</button></a>
