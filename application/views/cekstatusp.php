      ...
      <section class="content">
        ...
        <div class="box box-default">
         ...
         <div class="box box-default">
          ...
          <div class="box-body">        
                <div class="form-group" align="center">
                  <label for="exampleInputEmail1">Maaf anda belum melakukan registrasi atau belum melakukan validasi.lakukan validasi melalui link berikut <a href="http://pencatarma.stimart-amni.ac.id/registrasi"><button type="button" class="btn btn-block btn-primary btn-sm">Konfirmasi Pendaftaran</button></a>.jika belum sama sekali melakukan registrasi klik link berikut <a href="http://pencatarma.stimart-amni.ac.id/registrasi">disini</a>.</label>
                </div>   
                <!-- <button type="submit" name="submit" class="btn btn-primary">Cek Data</button> -->
          </div>
          <?php } ?>
