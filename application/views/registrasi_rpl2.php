    ...
    <div class="container">
      ...
      <section class="content">
        <div class="callout callout-info">
          ...
          <p>Persyaratan Penerimaan Calon Mahasiswa sebagai berikut:</p>
          <p><b>SYARAT UMUM</b></p>
          <ul>
          ...
          <ul>
            ...
            <li>Calon mahasiswa Fakultas Teknik memenuhi kriteria sebagai berikut:</li>
            <ul>
              <li>SMA atau Madrasah Aliyah (MA)-(Semua Program Studi).</li>
              <li>SMA -IPA</li>
              <li>SMK/MAK Teknik (khusus prodi Teknik Mesin).</li>
            </ul>
          </ul>
        </div>
            ...
            echo $this->session->flashdata('error'); ?>
              <form action="<?php echo base_url() ?>cetakRegistrasi" name="form1" id="form1" method="post" enctype="multipart/form-data"> 
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" name="informasi" id="infoSrmasi">
                    <option> </option>
                ...
                <div class="form-group">
                  ...
                  <div class="radio">
                    <label>
                      <input type="radio" name="kelas" id="optionsRadios1" value="reg_sore">
                      Reguler Sore
                    </label>
                  </div>
                   <div class="radio">
                    <label>
                      <input type="radio" name="kelas" id="optionsRadios1" value="reg_weekend">
                      Reguler Weekend
                    </label>
                  </div>
                 <!--  <div class="radio">
                ...
                <!--  <div class="form-group">
                  <input type="radio" name="ref_radio" id="ref_radio" value="Apakah anda memiliki kode Referral ?">
                ...
                </div> --><input type="hidden" name="ref" value="0">
