    ...
    <div class="container">
      ...
      <section class="content">
        <div class="callout callout-info">
          <h4>Tips!</h4>
          <p># Berikut adalah halaman untuk cek status pendaftaran calon Taruna / Mahasiswa UNIMAR AMNI Semarang.</p>
          ...
          <div class="box-body">
              ...
              <form  name="form1" id="form1" method="post">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="no" name="no" placeholder="Masukan Nomer Pendaftaran">
                </div>
                <div class="form-group">
