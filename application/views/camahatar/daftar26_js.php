 ...
 // Fungsi untuk memeriksa validitas email
  function checkEmail() {
    ...
    if (emailRegex.test(email)) {
      // Jika format valid, cek ke server
  ...
  // Fungsi untuk memeriksa apakah email sudah tersedia (Ajax)
  function isEmailAvailable(email) {
    $.ajax({
      ...
      success: function (response) {
        var emailMessage = document.getElementById("emailMessage");
        if (response === "available") {
          emailMessage.innerHTML = "Email tersedia.";
          emailMessage.style.color = "green";
          validateForm();
        } else {
          emailMessage.innerHTML = "Email sudah digunakan. Silakan pakai email lain.";
          emailMessage.style.color = "red";
          disableForm();
        }
      },
