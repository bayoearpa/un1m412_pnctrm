   ...
   <section class="video-section">
    <div class="container-fluid">
      <div class="embed-responsive embed-responsive-16by9">
        <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/APxCBPfOzEw?autoplay=1&loop=1&playlist=APxCBPfOzEw&mute=1" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
      </div>
    </div>
  </section>
    ...
    <div class="row">
      ...
      <div class="col-md-6 d-flex align-items-center">
        <div class="text-container">
          ...
          <a class="btn btn-primary portfolio-item" href="#portfolio-modal-1">Selengkapnya</a>
        </div>
      </div>
    </div>
    <div class="row mt-5">
    ...
    <div class="row">
      <div class="col-lg-12 mr-auto">
        ...
        <div class="col-lg-12 text-center">
          ...
          <a class="btn-custom btn-xl portfolio-item" href="#portfolio-modal-4" target="_blank">
   ...
   <section class="contact text-white" id="contact" style="background-color: #01317d; color: white;">
      <div class="container">
        <h2 class="text-center text-uppercase text-third mb-0">Jadwal Seleksi</h2><br>
         <center><img src="<?php echo base_url() ?>assets/front1/img/jadwal_test.png" width="100%"></center>
    ...
    <div class="portfolio-modal mfp-hide" id="portfolio-modal-10">
      <div class="portfolio-modal-dialog bg-white">
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-8 mx-auto">
              <h2 class="text-secondary text-uppercase mb-0  text-center">D4 MANAJEMEN PELABUHAN DAN LOGISTIK MARITIM</h2>
              <!-- <hr class="star-dark mb-5">
              <img class="img-fluid mb-5" src="img/portfolio/game.png" alt="">
              <p class="mb-5">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Mollitia neque assumenda ipsam nihil, molestias magnam, recusandae quos quis inventore quisquam velit asperiores, vitae? Reprehenderit soluta, eos quod consequuntur itaque. Nam.</p>
              <a class="btn btn-primary btn-lg rounded-pill portfolio-modal-dismiss" href="#">
