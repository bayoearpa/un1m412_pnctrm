...
<center><p style="margin: 0px;text-align: center;">DAFTAR HADIR SELEKSI CALON TARUNA - MAHASISWA T.A <?php echo $ta; ?></p></center>
...
<table width="100%" border="1" style="border: 1px solid black;border-collapse: collapse;">
		<tr>
			...
			<th colspan="3"><center>Tanda Tangan</center></th>
		</tr>
		<tr>
			<th>Hadir 1</th>
			<th>Hadir 2</th>
