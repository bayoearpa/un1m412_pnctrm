        ...
        <div class="box box-default">
          ...
          <div class="box-body">
            <?php 
                foreach($catar as $c){ 
                 ?>
              <form action="<?php echo base_url() ?>baak/edit_pmdk" name="form1" id="form1" method="post">
                <div class="form-group">
                  <label for="exampleInputEmail1">Nama</label>
                  <input type="hidden" name="no" id="no" value="<?php echo $c->no ?>"> 
                  <input type="text" class="form-control" id="nama" name="nama" value="<?php echo $c->nama ?>">
                </div>
               <!--  <div class="form-group">
               ...
               <!--  <div class="form-group">
                ...
                <label for="exampleInputEmail1">Jenis Kelamin</label>
                  <div class="radio">
                    <label>
                      <input type="radio" name="jk" id="jk" value="Pria" <?php echo ($c->jk == 'Pria') ? 'checked' : ''; ?>>
                      Pria
                    </label>
                  </div>
                  <div class="radio">
                    <label>
                      <input type="radio" name="jk" id="jk" value="Wanita" <?php echo ($c->jk == 'Wanita') ? 'checked' : ''; ?>>
                      Wanita
                    </label>
                  </div>
                </div>
                <div class="form-group">
                  <label>Alamat</label>
                  <textarea class="form-control" name="alamat" id="alamat" rows="3" placeholder="Masukkan Alamat Anda"><?php echo $c->alamat ?></textarea>
                </div>
<!--                 <div class="form-group">
...
<!--                 <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" name="kategori_sek" id="kategori_sek">
                    <option value="<?php echo $c->kategori_sek ?>"><?php echo $c->kategori_sek ?><option>
                ...
                <div class="form-group">
                  ...
                  <select class="form-control select2" id="prodi_lama" name="prodi_lama" style="width: 100%;">
                    <option value="<?php echo $c->prodi_lama ?>"><?php echo $c->prodi_lama ?><option>
...
<!--                 <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="asek" name="asek" placeholder="Masukan Asal Sekolah Anda" value="<?php echo $c->asek ?>">
                </div>
               <!--  <div class="form-group">
               ...
               <!--  <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" name="prodi" id="prodi">
                    <option value="<?php echo $c->prodi ?>"><?php echo $prodi ?><option>
                 ...
                 <div class="form-group">
                  ...
                  <select class="form-control" name="gelombang" id="gelombang">
                    <option value="<?php echo $c->gelombang ?>"><?php echo $c->gelombang ?> <option>
