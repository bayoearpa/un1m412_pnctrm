...
<center><p style="margin: 0px;text-align: center;">REKAP KESEHATAN CALON TARUNA - MAHASISWA T.A <?php echo $ta; ?></p></center>
<center><p style="margin: 0px;text-align: center;">TANGGAL : <?php echo $tgl; ?></p></center>	
<table width="100%">
	<tr>
	<th align="left"><h3>
<?php echo $jurusan." PMDK";?>
</h3></th>
	<th align="right">
		<h3>
	<?php if ($jk=="Pria") {
...
<table width="100%" border="1" style="border: 1px solid black;border-collapse: collapse;">
		<tr>
			...
			<th rowspan="2">L/P</th>
			<th colspan="5">TB/BB</th>
			<th colspan="5">TD</th>
			<th colspan="5">NADI/MNT</th>
			<th colspan="5">MATA</th>
			<th colspan="5">HEPATITIS</th>
			<th colspan="5">POSTUR</th>
