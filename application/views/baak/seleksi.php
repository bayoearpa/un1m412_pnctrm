            ...
            <div class="box-body">
              <table id="example4" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  ?></td>
                  <td>
                    <a href="<?php echo base_url() ?>baak/prosesseleksi/<?php echo $c->no; ?>"><button type="button" name="submit" id="prosesseleksi" class="btn btn-primary">Proses Seleksi</button></a>
