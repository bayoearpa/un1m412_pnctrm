...
<center><p style="margin: 0px;text-align: center;">REKAP NILAI PSYKOTEST CALON TARUNA - MAHASISWA T.A <?php echo $ta; ?></p></center>
...
<table width="100%" border="1" style="border: 1px solid black;border-collapse: collapse;">
		<tr>
			...
			<th rowspan="2">L/P</th>
			<th rowspan="2">TTD Hadir</th>
			<th rowspan="2">Kepribadian</th>
			<th rowspan="2">Intelegensi</th>
