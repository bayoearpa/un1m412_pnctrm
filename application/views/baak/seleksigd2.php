        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Data Pencatarma Sudah Seleksi Gelombang Dini TF</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example4" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  ?></td>
                  <td>
                      <a href="<?php echo base_url() ?>baak/prosesseleksitf/<?php echo $c->no; ?>"><button type="button" name="submit" id="prosesseleksi" class="btn btn-primary">Proses Seleksi</button></a>
                   </td>
                </tr>
               <?php } ?>
                </tbody>
