    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="<?php echo base_url() ?>dekan/get_summary_prov_2024"><i class="fa fa-money"></i>Statistik per Provinsi</a></li>
            <li class="active"><a href="<?php echo base_url() ?>dekan/get_summary_kabkota_2024"><i class="fa fa-money"></i>Statistik per Kab / Kota</a></li>
            <li><a href="<?php echo base_url() ?>dekan/get_summary_sekolah_2024"><i class="fa fa-paperclip"></i>Statistik per sekolah</a></li>
            <li><a href="<?php echo base_url() ?>dekan/get_summary_sumber_2024"><i class="fa fa-paperclip"></i>Statistik Sumber Informasi</a></li>
          </ul>
        </li>
         <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="<?php echo base_url() ?>dekan/get_summary_prov_2023"><i class="fa fa-money"></i>Statistik per Provinsi</a></li>
            <li class="active"><a href="<?php echo base_url() ?>dekan/get_summary_kabkota_2023"><i class="fa fa-money"></i>Statistik per Kab / Kota</a></li>
            <li><a href="<?php echo base_url() ?>dekan/get_summary_sekolah_2023"><i class="fa fa-paperclip"></i>Statistik per sekolah</a></li>
            <li><a href="<?php echo base_url() ?>dekan/get_summary_sumber_2023"><i class="fa fa-paperclip"></i>Statistik Sumber Informasi</a></li>
          </ul>
        </li>
         <li class="treeview">
          <a href="#">
        ...
        <div class="col-lg-3 col-xs-6">
          <div class="box">
            ...
            'tbl_catar_validasi_2024.aktif' => '1'      
             ...
             <div class="box-body" style="">
              <a href="#">Sudah Validasi (Gelombang Dini)</a>
               <?php 
             $where2= array(
            'id_gelombang' => '1',  
              );
            ...
            'tbl_catar_validasi_2024.aktif' => '1'      
             ...
             <div class="box-body" style="">
              <a href="#">Sudah Validasi (Gelombang Dini TF)</a>
               <?php 
             $where2= array(
            'id_gelombang' => '1',  
              );
        ...
        <div class="col-lg-3 col-xs-6">
          <div class="box">
            ...
            'tbl_catar_daful_2024.aktif' => '1'      
             ...
             <div class="box-body" style="">
              <a href="#">Daftar Ulang (Kelas Transfer)</a>
               <?php 
             $where2= array(
            'id_gelombang' => '1',  
              );
            ...
            <div class="box-body" style="">
              <a href="#">Daftar Ulang (Gelombang Dini)</a>
               <?php 
             $where2= array(
            'id_gelombang' => '1',  
              );
            ...
            'tbl_catar_daful_2024.aktif' => '1'      
             ...
             <div class="box-body" style="">
              <a href="#">Daftar Ulang (Gelombang Dini TF)</a>
               <?php 
             $where2= array(
            'id_gelombang' => '1',  
              );
