...
<html lang="en">
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg bg-secondary fixed-top text-uppercase" id="mainNav">
      ...
      <li class="nav-item mx-0 mx-lg-1">
              <a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="<?php echo base_url() ?>camahatar">Masuk</a>
            </li> 
          </ul>
        </div>
      </div>
...
<!--                 <a class="btn btn-xl btn-outline-warning js-scroll-trigger" href="https://drive.google.com/file/d/10LxFLgabglyyoA6VFowGHCX86AMJPqgn/view?usp=sharing" target="_blank">
   ...
   <section class="contact" id="contact">
      <div class="container">
        ...
        <div class="text-center mt-4">
         <center><img src="<?php echo base_url() ?>assets/front1/img/alur_gel1_20232.png" width="100%"></center>
        </div>
      <!--   <div class="text-center mt-4">
        ...
        <div class="container">
          <div class="row">
           ...
           <center>
               ...
               <!--  <a class="btn btn-primary btn-lg rounded-pill" href="<?php //echo base_url() ?>registrasi_eks">
                <i class="fa fa-sign-in"></i>
                Isi Biodata (Registrasi Kelas Transfer)</a> -->
              </center>
            </div>
          </div>
        </div>
